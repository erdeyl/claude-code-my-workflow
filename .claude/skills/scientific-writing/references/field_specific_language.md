...
- Report concentrations with appropriate units (mM, uM, nM, or % w/v, v/v)
...
- Use mathematical notation consistent with field standards (e.g., hbar for reduced Planck constant)
